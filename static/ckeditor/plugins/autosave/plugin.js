...
(function() {
    ...
    CKEDITOR.plugins.add("autosave", {
        ...
        init: function (editor) {
            ...
            if (localStorage.getItem('autosave' + editor.name)) {

                var autoSavedContent = localStorage.getItem('autosave' + editor.name);
                ...
                if (editorLoadedContent == autoSavedContent) {
                    ...
                    localStorage.removeItem('autosave' + editor.name);
    ...
    var onTimer = function (event) {
        if (savingActive) {
            ...
            savingActive = true;
            // save content
            localStorage.setItem('autosave' + event.editor.name, event.editor.getData());
            savingActive = false;
        } 
    };
